...
<p className="text-base md:text-lg text-gray-600 leading-relaxed mb-8 max-w-lg mx-auto md:mx-0">
  ...
  focused on clean architecture, intelligent automation, scalability, and exceptional user experience.
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center md:justify-start mt-4">
                        <a
                            href="#contact"
                            className="inline-flex items-center justify-center gap-2 px-6 py-3 w-full sm:w-auto max-w-xs sm:max-w-none bg-red-500 text-white font-semibold rounded-xl shadow-md hover:bg-red-600 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
                        >
                            👋  Let's Connect!
                        </a>
                        <a
                            ...
                            className="inline-flex items-center justify-center gap-2 px-6 py-3 w-full sm:w-auto max-w-xs sm:max-w-none bg-white text-purple-600 font-semibold border-2 border-purple-600 rounded-xl shadow-md hover:bg-purple-600 hover:text-white hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
                        >
                            Download CV
                        </a>
                    </div>
                ...
                <div className="flex justify-center order-1 md:order-2 fade-in delay-200">
                    <div className="relative w-72 h-72 sm:w-80 sm:h-80 md:w-[30rem] md:h-[30rem]">
